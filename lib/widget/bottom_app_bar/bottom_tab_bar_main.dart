...
double _kActiveFontSize = Dimens.font_space_10;
double _kInactiveFontSize = Dimens.font_space_10;
double _kTopMargin = 9.0;
double _kCenterMargin = 4.0;
double _kBottomMargin = 7.0;
double _kLeftRightMargin = Dimens.ratio_width_6;
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  Widget _buildFixedLabel() {
    ...
    return Align(
      ...
      heightFactor: 1.0,
      child: Container(
        margin: EdgeInsets.only(bottom: _kBottomMargin, top: _kCenterMargin),
                ...
                Material(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(bottom: additionalBottomPadding,
                        left: _kLeftRightMargin,right: _kLeftRightMargin),
